		...
		if (mAtlas.spriteMaterial != null)
		{
			...
			if (sprite != null)
			{
				...
				if (tex != null)
				{
					...
					EditorGUILayout.Separator();
					GUI.backgroundColor = Color.white;
					NGUIEditorTools.IntVector clipA = NGUIEditorTools.IntPair("Clip", "clipX", "clipY", sprite.clipX, sprite.clipY);
					NGUIEditorTools.IntVector clipB = NGUIEditorTools.IntPair(null, "clipWidth", "clipHeight", sprite.clipWidth, sprite.clipHeight);
