...
public class UILabel : UIWidget
{
	...
	[SerializeField] public Crispness keepCrispWhenShrunk = Crispness.Never;
    ...
    [HideInInspector][SerializeField] bool mIsDigitStyle = true;
	...
	public string printedText
	{
		get
		{
			if (!string.IsNullOrEmpty(mText))
			{
				...
				{
					//added
					string sRefinedTxt = mText;
					if (isDigit(sRefinedTxt))
						sRefinedTxt = NGUIText.SpaceDigitString(sRefinedTxt);
