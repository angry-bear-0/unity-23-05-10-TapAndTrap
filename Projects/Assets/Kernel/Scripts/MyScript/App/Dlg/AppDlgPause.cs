...
public class AppDlgPause : AppDlgBase
{
    ...
    {
        GameObject obj = Instantiate(Resources.Load("Prefabs/Dlg/DlgPause")) as GameObject;
        ...
        obj.GetComponent<AppDlgPause>().Init(_dele);
    ...
    public void Init(DlalogReturnDelegate _dele)
    {
        ...
        _LblLevel.text = string.Format("Level {0}", AppClient.me.lastLevel + 1);
